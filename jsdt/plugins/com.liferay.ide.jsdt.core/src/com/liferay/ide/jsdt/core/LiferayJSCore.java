...
package com.liferay.ide.jsdt.core;
 ...
 */
public class LiferayJSCore extends Plugin
{

    // The shared instance
    private static LiferayJSCore plugin;

    // The plugin ID
    public static final String PLUGIN_ID = "com.liferay.ide.jsdt.core"; //$NON-NLS-1$
     ...
     */
    public static LiferayJSCore getDefault()
    {
        return plugin;
    }
