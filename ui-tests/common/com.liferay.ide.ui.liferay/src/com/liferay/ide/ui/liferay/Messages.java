...
public interface Messages {
	...
	public static final String A_LIFERAY_WORKSPACE_PROJECT_ALREADY_EXISTS =
		"A Liferay Workspace project already exists in this Eclipse instance.";

	public static final String A_PACKAGE_NAME_CANNOT_START_OR_END_WITH_A_DOT =
	...
	public static final String CREATE_A_NEW_SOURCE_FOLDER = "Create a new source folder.";

	public static final String CREATE_A_PORTLET_CLASS = "Create a portlet class.";
	...
	public static final String ENTER_A_PROJECT_NAME = "Enter a project name.";
	...
	public static final String INVALID_LIFERAY_WORKSPACE = "Invalid Liferay Workspace";

	public static final String INVALID_PACKAGE_NAME = "Invalid package name";

	public static final String IS_AN_INVALID_CHARACTER_IN_RESOURCE_NAME = " is an invalid character in resource name ";

	public static final String IS_AN_INVALID_NAME_ON_PLATFORM = " is an invalid name on this platform.";

	public static final String IS_NOT_A_VALID_IDENTIFIER = " is not a valid identifier";

	public static final String IS_NOT_A_VALID_JAVA_IDENTIFIER = " is not a valid Java identifier";

	public static final String IS_NOT_A_VALID_PATH = " is not a valid path";

	public static final String IS_NOT_A_VALIDA_JAVA_PACKAGE_NAME = " is not a valid Java package name";

	public static final String IS_NOT_AMONG_POSSIBLE_VALUES = " is not among possible values";

	public static final String IS_NOT_AN_ABSOLUTE_PATH = " is not an absolute path.";
	...
	public static final String LOCATION_IS_NOT_RECOGNIZED_AS_A_VALID_PROJECT_TYPE =
		"Location is not recognized as a valid project type.";

	public static final String LOCATION_IS_NOT_ROOT_LOCATION =
	...
	public static final String MUST_SPECIFY_VAADIN_PORTLET_CLASS = "Must specify a vaadin portlet class.";

	public static final String MUST_SPECIFY_VALID_ENTRY_WEIGHT = "Must specify a valid double for entry weight.";
	...
	public static final String PORTLET_NAME_ALREADY_EXISTS = "Portlet name already exists.";

	public static final String PORTLET_NAME_IS_EMPTY = "Portlet name is empty.";

	public static final String PORTLET_SUPERCLASS_MUST_BE_A_PORTLET_VALID =
		"Portlet superclass must be a valid portlet class.";

	public static final String PROJECT_ALREADY_CONTAINS_SERVICE_BUILDER_XML_FILE =
		"Project already contains service.xml file, please select another project.";

	public static final String PROJECT_NAME_ALREADY_EXSIT = "Project name already exists.";
	...
	public static final String RESOURCE_BUNDLE_FILE_MUST_VALID_PATH = "Resource bundle file path must be a valid path.";

	public static final String SDK_DOES_NOT_EXIST = "SDK does not exist.";
	...
	public static final String SELECT_LOCATION_OF_MODULE_PROJECT_DIRECTORY =
	...
	public static final String SPECIFY_PORTAL_BUNDLE_LOCATION =
	...
	public static final String TEMPLATE_FILE_NAME_IS_INVALID = "Template file name is invalid.";

	public static final String TEMPLATE_ID_IS_INVALID = "Template id is invalid.";
	...
	public static final String THE_PROJECT_NAME_IS_INVALID = "The project name is invalid.";

	public static final String THE_SERVER_OR_RUNTIME_NAME_IS_ALREADY_IN_USE =
	...
	public static final String VIEW_FILE_OEVERWRITTEN = "View file already exists and will be overwritten.";

	public static final String VIEW_JSP_EXSITS_AND_OVERWRITTEN = "View jsp already exists and will be overwritten.";

	public static final String VIEWS_SHOULD_IN_WEB_INF_FOLDER = "The views should be generated in the WEB-INF folder.";

	public static final String WAP_TEMPLATE_FILE_EXIST = "WAP template file already exists and will be overwritten.";

	public static final String WAP_TEMPLATE_FILE_NAME_IS_INVALID = "WAP template file name is invalid.";

	public static final String WARNING_JAVA_TYPE_START_WITH_AN_UPPERCASE_LETTER =
