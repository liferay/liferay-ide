 ...
 * @author Terry Jia
 */
public class GradlePreferencesDialog extends Dialog {

	public GradlePreferencesDialog(SWTBot bot) {
		super(bot, PREFERENCES);
	}

	public CheckBox getAutomaticSync() {
		return new CheckBox(getShell().bot(), "Automatic Project Synchronization");
	}
