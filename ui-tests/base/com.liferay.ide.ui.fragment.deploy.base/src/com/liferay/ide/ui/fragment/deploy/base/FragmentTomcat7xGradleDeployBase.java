...
package com.liferay.ide.ui.fragment.deploy.base;
 ...
 * @author Terry Jia
 */
public class FragmentTomcat7xGradleDeployBase extends ServerTestBase {
	...
	public void deployFragmentWithJsp() {
		...
		viewAction.servers.removeModule(server.getStartedLabel(), project.getName());
