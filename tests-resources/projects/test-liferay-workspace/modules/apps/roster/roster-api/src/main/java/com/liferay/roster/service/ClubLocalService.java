...
/**
 * Provides the local service interface for Club. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ClubLocalServiceUtil
...
public interface ClubLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClubLocalServiceUtil} to access the club local service. Add custom service methods to {@link com.liferay.roster.service.impl.ClubLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
