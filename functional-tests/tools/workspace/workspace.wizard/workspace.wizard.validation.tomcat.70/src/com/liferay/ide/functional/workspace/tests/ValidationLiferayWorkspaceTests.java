...
public class ValidationLiferayWorkspaceTests extends SwtbotBase {
	...
	public void checkInitialState() {
		...
		validationAction.assertTextEquals("7.2.1-1", wizardAction.newLiferayWorkspace.getTargetPlatform());
	...
	public void checkTargetPlatform() {
		...
		validationAction.assertEquals(expectedTargetPlatform[9], targetPlatformComboBox.getText());
