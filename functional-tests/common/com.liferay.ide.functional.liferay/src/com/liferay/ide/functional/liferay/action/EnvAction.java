...
import com.liferay.ide.functional.liferay.util.BundleInfo;
import com.liferay.ide.functional.liferay.util.CSVReader;
			...
			if ((_bundlesDir == null) || _bundlesDir.equals("") || _bundlesDir.equals("null")) {
				...
				try {
					...
					if (filePath.contains("target/work/configuration")) {
						int index = filePath.indexOf("/functional-tests/");
