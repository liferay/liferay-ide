 ...
 *******************************************************************************/
package com.liferay.ide.common.ui.wizard;
...
import com.liferay.ide.common.ui.LiferayUIPlugin;
	...
	private void textChanged(String text) {
		...
		for (int i = 0; i < oldNames.size(); i++) {
			if ((isCaseSensitive && text.equals(oldNames.get(i))) || (!isCaseSensitive && text.equalsIgnoreCase(oldNames.get(i).toString()))) {
				status = new Status(IStatus.ERROR, LiferayUIPlugin.PLUGIN_ID, IStatus.ERROR, "Name already exists", null);
				updateStatus(status);
				okButton.setEnabled(false);
				break;
			}
