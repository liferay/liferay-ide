...
package com.liferay.ide.common.core.util;

import com.liferay.ide.common.core.CommonPlugin;
...
public class FileUtil {
	...
	public static void copyFileToDir(File file, File dir) {
		...
		try {
			...
			CommonPlugin.logError("Unable to copy file " + file.getName() + " to " + dir.getAbsolutePath());
		}
		finally {
			try {
				if (in != null)
	...
	public static String readContents(File file, boolean includeNewlines) {
		...
		try {
			...
			CommonPlugin.logError("Could not read file: " + file.getPath());
		}
