...
public class AUILiferayTagsAutoCorrectTest {

	@Test
	public void autoCorrectProblems() throws Exception {
		File tempFolder = Files.createTempDirectory("autocorrect").toFile();
		File testFile = new File(tempFolder, "AUILiferayTagTest.jsp");

		tempFolder.deleteOnExit();

		File originalTestfile = new File("jsptests/aui-liferay/AUILiferayTagTest.jsp");
		...
		for (ServiceReference<FileMigrator> mref : mrefs) {
			...
			if (migrator.getClass().getName().contains("AUILiferayTags")) {
