...
public class NewVaadinPortletWizardTests extends SWTBotBase implements VaadinPortletWizard, WizardBase, PortletWizard
{
    ...
    public static void createJSFPortletProject() throws Exception
    {
        ...
        page1.createSDKProject( projectName );
        page1.next();
    ...
    public void closeWizard()
    {
        try
        {
            shellBot.close( TITLE_NEW_LIFERAY_VAADIN_PORTLET );
        }
        catch( Exception e )
        {
        }
    ...
    public void testContentDefaultValues() throws Exception
    {
        ...
        /*
         * assertTrue( page.getPortletPluginProject().isEnabled() ); assertTrue( page.getSourceFolder().isEnabled() );
         * assertTrue( page.getApplicationClass().isEnabled() ); assertTrue( page.getJavaPackage().isEnabled() );
         * assertTrue( page.getSuperClass().isEnabled() ); assertTrue( page.getPortletClass().isEnabled() );
         */
