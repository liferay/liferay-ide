 ...
 * @author Ashley Yuan
 */
public class IconSelectionPageObject extends AbstractSelectionPageObject<SWTBot> implements LiferayPortletWizard
{

    public IconSelectionPageObject( SWTBot bot, String title, int labelIndex )
    {
