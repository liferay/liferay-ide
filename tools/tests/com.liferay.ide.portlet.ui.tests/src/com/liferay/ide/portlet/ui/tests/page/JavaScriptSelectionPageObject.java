 ...
 * @author Ashley Yuan
 */
public class JavaScriptSelectionPageObject extends AbstractSelectionPageObject<SWTBot> implements LiferayPortletWizard
{

    public JavaScriptSelectionPageObject( SWTBot bot, String title, int labelIndex )
    {
