...
public class AssetPreviewTagsTest {
	...
	public void findUpgradeProblems() throws Exception {
		...
		List<UpgradeProblem> problems = m.findUpgradeProblems(new File("jsptests/asset-preview/"), UpgradePlanProblemsTestConstants.TEST_VERSIONS, new NullProgressMonitor());
