 ...
 * @author Terry Jia
 */
public class EmptyFileCheckingTest {
	...
	public void findUpgradeProblems() throws Exception {
		...
		List<UpgradeProblem> problems = m.findUpgradeProblems(new File("projects/emptyfiles/"), UpgradePlanProblemsTestConstants.TEST_VERSIONS, new NullProgressMonitor());
