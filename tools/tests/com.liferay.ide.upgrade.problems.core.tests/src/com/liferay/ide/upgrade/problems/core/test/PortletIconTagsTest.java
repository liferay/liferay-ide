...
public class PortletIconTagsTest {
	...
	public void findUpgradeProblems() throws Exception {
		...
		List<UpgradeProblem> problems = m.findUpgradeProblems(new File("jsptests/portlet-icon/"), UpgradePlanProblemsTestConstants.TEST_VERSIONS, new NullProgressMonitor());
