...
public class PortletConfigGetFormatMethodsTest extends APITestBase {
	...
	public String getComponentName() {
		return "com.liferay.ide.upgrade.problems.core.internal.liferay70.PortletConfigGetFormatMethods";
	}
	...
	public void languageUtilJspFile() {
		...
		List<UpgradeProblem> problems = fmigrator.analyze(languageUtilJspFile);
	...
	public void unicodeLanguageImplFile() throws Exception {
		...
		List<UpgradeProblem> problems = fmigrator.analyze(unicodeLanguageImplFile);
