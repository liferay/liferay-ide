 ...
 * @author Terry Jia
 */
public class AssetRendererGetSummaryDeclTest extends APITestBase {

	@Override
	public String getComponentName() {
		return "com.liferay.ide.upgrade.problems.core.internal.liferay70.AssetRendererGetSummaryDecl";
	}
