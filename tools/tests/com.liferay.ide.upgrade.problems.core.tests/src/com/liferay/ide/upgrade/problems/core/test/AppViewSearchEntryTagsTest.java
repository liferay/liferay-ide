...
public class AppViewSearchEntryTagsTest {
	...
	public void findUpgradeProblems() throws Exception {
		...
		List<UpgradeProblem> problems = m.findUpgradeProblems(new File("jsptests/app-view-search-entry/"), UpgradePlanProblemsTestConstants.TEST_VERSIONS, new NullProgressMonitor());
