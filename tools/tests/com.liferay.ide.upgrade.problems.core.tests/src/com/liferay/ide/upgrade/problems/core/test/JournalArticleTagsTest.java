...
public class JournalArticleTagsTest {
	...
	public void findUpgradeProblems() throws Exception {
		...
		List<UpgradeProblem> problems = m.findUpgradeProblems(new File("jsptests/journal-article-tags/"), UpgradePlanProblemsTestConstants.versions, new NullProgressMonitor());
