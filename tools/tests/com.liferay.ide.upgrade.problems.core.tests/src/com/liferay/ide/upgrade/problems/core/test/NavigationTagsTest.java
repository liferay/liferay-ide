...
public class NavigationTagsTest {
	...
	public void findUpgradeProblems() throws Exception {
		...
		List<UpgradeProblem> problems = m.findUpgradeProblems(new File("jsptests/navigation-tags/"), UpgradePlanProblemsTestConstants.versions, new NullProgressMonitor());
