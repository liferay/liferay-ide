...
package com.liferay.ide.upgrade.problems.test.provider;
...
public class JavaFileJDTTest {
	...
	public void checkGuessMethodInvocation() throws Exception {
		...
		List<FileSearchResult> results = javaFileChecker.findMethodInvocations(
	...
	public void checkMethodInvocation() throws Exception {
		...
		javaFileChecker.setFile(file);
		List<FileSearchResult> searchResults = javaFileChecker.findMethodInvocations("Foo", null, "bar", null);
	...
	public void checkMethodInvocationTypeMatch() throws Exception {
		...
		List<FileSearchResult> searchResults = javaFileChecker.findMethodInvocations(
	...
	public void checkStaticMethodInvocation() throws Exception {
		...
		javaFileChecker.setFile(file);
		List<FileSearchResult> searchResults = javaFileChecker.findMethodInvocations(null, "String", "valueOf", null);
