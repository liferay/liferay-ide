...
public class AUIColumnTagsTest {
	...
	public void findUpgradeProblems() throws Exception {
		...
		List<UpgradeProblem> problems = m.findUpgradeProblems(new File("jsptests/aui-column/"), UpgradePlanProblemsTestConstants.TEST_VERSIONS, new NullProgressMonitor());
