 ...
 * @author Terry Jia
 */
public class AssetRendererGetURLViewDeclTest extends APITestBase {

	@Override
	public String getComponentName() {
		return "com.liferay.ide.upgrade.problems.core.internal.liferay70.AssetRendererGetURLViewDecl";
	}
