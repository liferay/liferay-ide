 ...
 * @author Vicky Wang
 */
public class AddLanguagePropertyPageObject<T extends SWTBot> extends DialogPageObject<T>
    implements HookConfigurationWizard, ProjectWizard
{

    TextPageObject<SWTBot> languagePropertyFile;

    public AddLanguagePropertyPageObject( T bot )
    {
        this( bot, TEXT_BLANK );
    }

    public AddLanguagePropertyPageObject( T bot, String title )
    {
    ...
    {
        languagePropertyFile.setText( text );
    }
