 ...
 * @author Vicky Wang
 */
public class PropertySelectionPageObject<T extends SWTBot> extends DialogPageObject<T>
    implements HookConfigurationWizard, ProjectWizard
{

    TreePageObject<SWTBot> path;

    public PropertySelectionPageObject( T bot )
    {
        super( bot, TEXT_BLANK, BUTTON_CANCEL, BUTTON_OK );
        path = new TreePageObject<>( bot );
    }

    public PropertySelectionPageObject( T bot, String title )
    {
