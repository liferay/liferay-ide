 ...
 * @author Vicky Wang
 */
public class LiferayCustomJSPPageObject<T extends SWTBot> extends DialogPageObject<T>
    implements HookConfigurationWizard, ProjectWizard
{

    TreePageObject<SWTBot> path;

    public LiferayCustomJSPPageObject( T bot )
    {
        this( bot, TEXT_BLANK );
    }

    public LiferayCustomJSPPageObject( T bot, String title )
    {
