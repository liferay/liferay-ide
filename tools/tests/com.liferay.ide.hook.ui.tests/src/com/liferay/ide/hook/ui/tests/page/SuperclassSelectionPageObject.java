 ...
 * @author Vicky Wang
 */
public class SuperclassSelectionPageObject<T extends SWTBot> extends DialogPageObject<T>
    implements HookConfigurationWizard, ProjectWizard
{

    TextPageObject<SWTBot> superclass;

    public SuperclassSelectionPageObject( T bot )
    {
        this( bot, TEXT_BLANK );
    }

    public SuperclassSelectionPageObject( T bot, String title )
    {
        super( bot, title, BUTTON_CANCEL, BUTTON_OK );

        superclass = new TextPageObject<SWTBot>( bot, LABLE_CHOOSE_SUPERCLASS );
    }
