<div class="columns-1-3-2-nest" id="main-content" role="main">
			...
			<td class="aui-w66 portlet-column portlet-column-first">
				...
				<tr>
					...
					<td class="aui-w50 portlet-column portlet-column-last">
						<table class="portlet-layout">
						<tr>
							<td class="aui-w100 portlet-column portlet-column-only" id="column-7">
			...
			<div class="aui-w66 portlet-column portlet-column-first">
				...
				<div class="portlet-layout">
					...
					<div class="aui-w50 portlet-column portlet-column-last">
						<div class="portlet-layout">
							<div class="aui-w100 portlet-column portlet-column-only" id="column-7">
								$processor.processColumn("column-7", "portlet-column-content portlet-column-content-only")
							</div>
						</div>
					</div>
