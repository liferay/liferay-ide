<div class="columns-1-3-2-nest-changed" id="main-content" role="main">
	...
	<div class="portlet-layout row-fluid">
		<div class="portlet-column portlet-column-first span8">
			<div class="portlet-layout row-fluid">
				<div class="portlet-column portlet-column-first span9" id="column-3">
			...
			<div class="portlet-layout row-fluid">
				...
				<div class="portlet-column portlet-column-last span6">
					<div class="portlet-layout row-fluid">
						<div class="portlet-column portlet-column-first span10" id="column-6">
							$processor.processColumn("column-6", "portlet-column-content portlet-column-content-first")
						</div>

						<div class="portlet-column portlet-column-last span2" id="column-7">
		...
		<div class="portlet-column portlet-column-last span4" id="column-8">
