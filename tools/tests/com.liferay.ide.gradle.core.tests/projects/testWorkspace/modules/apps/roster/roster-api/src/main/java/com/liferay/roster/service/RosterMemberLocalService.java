...
/**
 * Provides the local service interface for RosterMember. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RosterMemberLocalServiceUtil
...
public interface RosterMemberLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RosterMemberLocalServiceUtil} to access the roster member local service. Add custom service methods to {@link com.liferay.roster.service.impl.RosterMemberLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
