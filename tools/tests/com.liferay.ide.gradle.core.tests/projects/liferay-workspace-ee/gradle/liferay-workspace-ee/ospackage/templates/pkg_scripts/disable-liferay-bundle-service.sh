...
##
## This script removes Liferay bundle's service of given name from OS startup.
##
...
echo '=============================================='
echo ' Disabling of Liferay bundle as an OS service '
echo '=============================================='

# Various distros use various commands: https://fedoraproject.org/wiki/SysVinit_to_Systemd_Cheatsheet
# First test if the command exists, based on http://stackoverflow.com/a/677212/4966203, then use it
# if available. Multiple commands may be used, which is fine.
...
if command -v update-rc.d >/dev/null 2>&1; then
	...
	update-rc.d -f $LIFERAY_SERVICE_NAME remove
...
if command -v chkconfig >/dev/null 2>&1; then
	...
	chkconfig $LIFERAY_SERVICE_NAME off
...
if command -v systemctl >/dev/null 2>&1; then
	...
	systemctl disable $LIFERAY_SERVICE_NAME
...
if [ $command_found -eq 0 ]; then
	echo "==> ERROR: No command to manage OS services found, cannot disable the service"
