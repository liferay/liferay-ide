...
@Component(
	property = {
		...
		"problem.summary=The attributes closeable, componentId, contributorKey, data, defaultEventHandler, destroyOnHide, elementClasses, spritemap, style, type in `clay:alert` tag was removed.",
		"problem.tickets=LPS-125256", "version=7.4"
	},
	service = FileMigrator.class
)
public class DeprecatedClayAlertTagAttributes extends JSPTagMigrator {

	public DeprecatedClayAlertTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:alert"};
