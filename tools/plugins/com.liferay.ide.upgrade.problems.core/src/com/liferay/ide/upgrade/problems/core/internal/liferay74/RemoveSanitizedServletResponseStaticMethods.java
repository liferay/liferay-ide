...
@Component(
	property = {
		...
		"problem.tickets=LPS-134188",
		"problem.title=Remove some static methods in com.liferay.portal.kernel.servlet.SanitizedServletResponse",
		"problem.section=#remove-sanitized-servlet-response-some-static-method", "version=7.4"
	},
