...
@Component(
	property = {
		"file.extensions=properties", "problem.title=liferay-versions key in Liferay Plugin Packages Properties 7.3",
		"problem.summary=In order to deploy this project to 7.3 the liferay-versions property must be set to 7.3.0+",
