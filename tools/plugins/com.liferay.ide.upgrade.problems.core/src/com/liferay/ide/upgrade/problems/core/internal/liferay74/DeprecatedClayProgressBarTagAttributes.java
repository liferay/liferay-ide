...
public class DeprecatedClayProgressBarTagAttributes extends JSPTagMigrator {

	public DeprecatedClayProgressBarTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:progressbar"};
