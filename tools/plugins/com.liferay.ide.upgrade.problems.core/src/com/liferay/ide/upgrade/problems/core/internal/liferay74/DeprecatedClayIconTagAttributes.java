...
@Component(
	property = {
		...
		"problem.summary=The attributes componentId, contributorKey, data, defaultEventHandler, elementClasses, monospaced, spritemap in `clay:icon` tag was removed.",
		"problem.tickets=LPS-125256", "version=7.4"
	},
	service = FileMigrator.class
)
public class DeprecatedClayIconTagAttributes extends JSPTagMigrator {

	public DeprecatedClayIconTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:icon"};
