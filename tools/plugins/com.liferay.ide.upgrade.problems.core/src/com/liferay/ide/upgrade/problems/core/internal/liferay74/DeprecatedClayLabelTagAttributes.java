...
@Component(
	property = {
		...
		"problem.summary=The attributes closeable, componentId, contributorKey, data, defaultEventHandler, elementClasses, href, message, size, spritemap, style in `clay:label` tag was removed.",
		"problem.tickets=LPS-125256", "version=7.4"
	},
	service = FileMigrator.class
)
public class DeprecatedClayLabelTagAttributes extends JSPTagMigrator {

	public DeprecatedClayLabelTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:label"};
