...
@Component(
	property = {
		...
		"problem.summary=The attributes componentId, contributorKey, data, defaultEventHandler, elementClasses, spritemap, style in `clay:sticker` tag was replaced by displayType.",
		"problem.tickets=LPS-125256", "version=7.4"
	},
	service = FileMigrator.class
)
public class DeprecatedClayStickerTagAttributes extends JSPTagMigrator {

	public DeprecatedClayStickerTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:sticker"};
