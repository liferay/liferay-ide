...
public class AutoCorrectUpgradeProblemsStepKeys {
	...
	public static final String DESCRIPTION =
		...
		"Types of fixes that are done automatically are: <ul><li>package imports</li><li>JSP tag names</li><li> " +
		"Liferay descriptor versions</li><li>XML descriptor content</li></ul></p>";
