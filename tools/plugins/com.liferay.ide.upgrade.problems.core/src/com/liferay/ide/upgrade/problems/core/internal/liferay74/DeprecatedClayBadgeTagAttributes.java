...
@Component(
	property = {
		...
		"problem.summary=The attributes componentId, contributorKey, data, defaultEventHandler, elementClasses, style in `clay:badge` tag was replaced by displayType.",
		"problem.tickets=LPS-125256", "version=7.4"
	},
	service = FileMigrator.class
)
public class DeprecatedClayBadgeTagAttributes extends JSPTagMigrator {

	public DeprecatedClayBadgeTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:badge"};
