...
@Component(
	property = {
		...
		"problem.summary=The attributes closeable, componentId, contributorKey, data, defaultEventHandler, destroyOnHide, elementClasses, spritemap, style, type in `clay:stripe` tag was removed.",
		"problem.tickets=LPS-125256", "version=7.4"
	},
	service = FileMigrator.class
)
public class DeprecatedClayStripeTagAttributes extends JSPTagMigrator {

	public DeprecatedClayStripeTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:stripe"};
