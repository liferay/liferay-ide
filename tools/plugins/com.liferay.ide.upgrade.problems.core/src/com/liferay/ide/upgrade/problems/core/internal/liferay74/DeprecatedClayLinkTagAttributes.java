...
@Component(
	property = {
		...
		"problem.summary=The attributes ariaLabel, buttonStyle, componentId, contributorKey, data, defaultEventHandler, elementClasses, iconAlignment, spritemap, style, target, title in `clay:link` tag was replaced by aria-label.",
		"problem.tickets=LPS-125256", "version=7.4"
	},
	service = FileMigrator.class
)
public class DeprecatedClayLinkTagAttributes extends JSPTagMigrator {

	public DeprecatedClayLinkTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:link"};
