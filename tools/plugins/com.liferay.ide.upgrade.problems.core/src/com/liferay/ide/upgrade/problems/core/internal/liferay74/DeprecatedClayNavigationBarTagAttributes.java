...
@Component(
	property = {
		...
		"problem.summary=The attributes componentId, contributorKey, data, defaultEventHandler, elementClasses, spritemap in `clay:navigation-bar` tag was removed.",
		"problem.tickets=LPS-125256", "version=7.4"
	},
	service = FileMigrator.class
)
public class DeprecatedClayNavigationBarTagAttributes extends JSPTagMigrator {

	public DeprecatedClayNavigationBarTagAttributes() {
	...
	private static final String[] _TAG_NAMES = {"clay:navigation-bar"};
