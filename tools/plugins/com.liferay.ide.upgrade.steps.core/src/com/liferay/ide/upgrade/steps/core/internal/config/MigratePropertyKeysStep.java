...
@Component(
	property = {
		"id=migrate_property_keys", "requirement=required", "order=2", "parentId=analyze_portal_ext_properties",
		"title=Migrate Property Keys"
	},
	scope = ServiceScope.PROTOTYPE, service = UpgradeStep.class
)
public class MigratePropertyKeysStep extends BaseUpgradeStep {
