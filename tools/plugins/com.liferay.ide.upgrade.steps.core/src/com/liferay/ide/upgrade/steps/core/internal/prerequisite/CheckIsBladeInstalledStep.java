...
@Component(
	property = {
		"id=check_is_blade_installed", "order=1", "requirement=recommended", "parentId=install_blade",
		"title=Check is Blade installed"
	},
	scope = ServiceScope.PROTOTYPE, service = UpgradeStep.class
)
public class CheckIsBladeInstalledStep extends BaseUpgradeStep {
