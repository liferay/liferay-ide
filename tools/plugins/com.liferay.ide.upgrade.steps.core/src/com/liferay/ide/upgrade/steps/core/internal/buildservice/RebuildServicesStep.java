...
@Component(
	property = {
		"categoryId=code", "description=" + RebuildServicesStepKeys.DESCRIPTION, "id=" + RebuildServicesStepKeys.ID,
		"imagePath=icons/build_service.png", "order=7", "title=" + RebuildServicesStepKeys.TITLE
	},
	scope = ServiceScope.PROTOTYPE, service = UpgradeStep.class
)
public class RebuildServicesStep extends BaseUpgradeStep {
