 ...
 * @author Greg Amerson
 */
public class PortalJarViewerFilter extends ViewerFilter {

	public PortalJarViewerFilter(File base, String[] roots, String[] existingJars) {
		this.base = base;
	...
	protected String[] existingJars = null;
