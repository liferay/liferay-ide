 ...
 * @author Terry Jia
 */
public class BooleanQuerySpecification extends StaticValueQuerySpecification {

	public BooleanQuerySpecification() {
		super(_visitor);

		_visitor.registerValue("true", "");
		_visitor.registerValue("false", "");
	}
