 ...
 * @author Terry Jia
 */
public class FinderColumnArrayableOperatorQuerySpecification extends StaticValueQuerySpecification {

	public FinderColumnArrayableOperatorQuerySpecification() {
		super(_visitor);

		_visitor.registerValue("AND", "");
		_visitor.registerValue("OR", "");
	}
