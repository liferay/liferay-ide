...
public class GearAnimator extends Animator
{
  ...
  private final AnimatorPage[] pages = new AnimatorPage[GEARS + 1];
  ...
  public final AnimatorPage[] getPages()
  {
    return pages;
  }
  ...
  public final AnimatorPage getSelectedPage()
  {
  ...
  protected boolean onKeyPressed(KeyEvent e)
  {
    ...
    if (e.character == 13)
    {
      AnimatorPage page = getSelectedPage();
  ...
  private AnimatorPage updatePage()
  {
  ...
  public abstract class Answer
  {
    ...
    public abstract Point getSize(GC gc, AnimatorPage page);

    public abstract Rectangle paint(GC gc, AnimatorPage page, int index, int x, int y, boolean hovered, boolean selected);
  }
  ...
  public class TextAnswer extends Answer
  {
    ...
    @Override
    public Point getSize(GC gc, AnimatorPage page)
    {
    ...
    @Override
    public Rectangle paint(GC gc, AnimatorPage page, int index, int x, int y, boolean hovered, boolean selected)
    {
   ...
   * @author Eike Stepper
   */
  public abstract class AnimatorPage
  {
    ...
    public AnimatorPage(int index, String title)
    {
      this.index = index;
      this.title = title;
    }
   ...
   * @author Eike Stepper
   */
  public class ImagePage extends AnimatorPage
  {
   ...
   * @author Eike Stepper
   */
  public class SummaryPage extends AnimatorPage
  {
