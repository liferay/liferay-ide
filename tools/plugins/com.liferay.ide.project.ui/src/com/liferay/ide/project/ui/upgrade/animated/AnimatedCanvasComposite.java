 ...
 * @author Eike Stepper
 */
public abstract class AnimatedCanvasComposite extends Canvas
{
  ...
  public AnimatedCanvasComposite(Composite parent, int style)
  {
    this(parent, style, DEFAULT_TIMER_INTERVAL);
  }

  public AnimatedCanvasComposite(Composite parent, int style, int timerInterval)
  {
    ...
    Button button = new Button(parent, SWT.RIGHT);
  ...
  public static abstract class Animator
  {
    ...
    private AnimatedCanvasComposite canvas;
    ...
    public final AnimatedCanvasComposite getCanvas()
    {
      return canvas;
    }
