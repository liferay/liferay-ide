 ...
 * @author Simon Jiang
 */
public class LiferayUpgradeImportBackActionPart extends  AbstractLiferayUpgradeNavigatorPart
{
    private final String buttonLabel = "&Back";
    ...
    protected void createButton( Composite composite, Presentation parent )
    {
        ...
        button.addSelectionListener( new SelectionAdapter()
        {
            ...
            {
                setOutlineSelection( parent, STEP_CONFIG_SOURCE );
            }
