...
@Component(
	property = {
		...
		"problem.tickets=no ticket number",
		"problem.title=BaseAssetRenderer API Changes",
		"problem.section=#changed-the-baseassetrenderer-apis-geticonpath-method-themedisplay-parameters",
		"implName=BaseAssetRendererGetIconPathDecl"
	},
...
public class BaseAssetRendererGetIconPathDecl extends JavaFileMigrator {
	...
	protected List<SearchResult> searchFile(File file, JavaFile javaFileChecker) {
		return javaFileChecker.findMethodDeclaration("getIconPath",
				new String[] { "ThemeDisplay" }, null);
	}
}