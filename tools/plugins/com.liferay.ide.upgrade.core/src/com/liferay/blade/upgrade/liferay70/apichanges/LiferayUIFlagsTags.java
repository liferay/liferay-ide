...
@Component(property = {
	...
	"problem.tickets=LPS-60967", "auto.correct=jsptag", "implName=LiferayUIFlagsTags"
},
...
public class LiferayUIFlagsTags extends JSPTagMigrator {
	...
	private static final String[] _newTagNames = {"liferay-flags:flags"};
	private static final String[] _tagNames = {"liferay-ui:flags"};
