...
public class CheckInstallationPrerequisitesStepKeys {
	...
	public static final String DESCRIPTION =
		...
		"necessary requirements.  While not every step is required, it is highly recommended to complete all " +
		"applicable steps to ensure you have a positive upgrade experience.";
