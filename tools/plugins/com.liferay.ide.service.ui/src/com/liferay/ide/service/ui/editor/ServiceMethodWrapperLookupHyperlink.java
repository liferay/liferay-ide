...
public class ServiceMethodWrapperLookupHyperlink extends ServiceMethodHyperlink
{
    ...
    public ServiceMethodWrapperLookupHyperlink(
        JavaEditor editor, final IRegion word, final SelectionDispatchAction action, final IMethod wrapperMethod,
    ...
    public void open()
    {
        JavaSourceViewer sourceViewer = (JavaSourceViewer) editor.getViewer();

        try
        {
            // call internal APIs to display quick heirarchy
            Field p = sourceViewer.getClass().getSuperclass().getDeclaredField( "fHierarchyPresenter" );
