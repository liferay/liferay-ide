 ...
 * @author Simon Jiang
 */
public class ConfigureProductVersionPossibleValuesService
	extends PossibleValuesService implements SapphireContentAccessor {

	public ConfigureProductVersionPossibleValuesService() {
	...
	@Override
	public void dispose() {
		ConfigureWorkspaceProductOp op = context(ConfigureWorkspaceProductOp.class);

		if (op != null) {
			SapphireUtil.detachListener(
				op.property(ConfigureWorkspaceProductOp.PROP_SHOW_ALL_VERSION_PRODUCT), _listener);
		}
	...
	protected void initPossibleValuesService() {
		...
		SapphireUtil.attachListener(op.property(ConfigureWorkspaceProductOp.PROP_SHOW_ALL_VERSION_PRODUCT), _listener);
	}
