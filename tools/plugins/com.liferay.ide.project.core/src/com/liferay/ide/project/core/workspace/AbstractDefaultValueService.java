 ...
 * @author Simon Jiang
 */
public abstract class AbstractDefaultValueService extends DefaultValueService implements SapphireContentAccessor {
	...
	protected abstract Value<Object> getDefaultValueProperty();

	protected abstract String initDefaultValue();
	...
	protected void initDefaultValueService() {
		...
		_defaultValue = initDefaultValue();
	}

	private PossibleValuesService _possibleValuesService() {
		Value<Object> property = getDefaultValueProperty();
