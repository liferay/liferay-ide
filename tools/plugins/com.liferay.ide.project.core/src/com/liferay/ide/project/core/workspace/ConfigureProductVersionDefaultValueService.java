 ...
 * @author Simon Jiang
 */
public class ConfigureProductVersionDefaultValueService extends DefaultValueService implements SapphireContentAccessor {

	public ConfigureProductVersionDefaultValueService() {
	}
	...
	private PossibleValuesService _possibleValuesService() {
		...
		Value<Object> property = op.property(ConfigureWorkspaceProductOp.PROP_PRODUCT_VERSION);
