...
import java.util.*;
import com.liferay.ide.portlet.vaadin7.core.operation.*;
...
public class Vaadin7PortletTemplate implements INewVaadin7PortletClassDataModelProperties
{
  protected static String nl;
  public static synchronized Vaadin7PortletTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    Vaadin7PortletTemplate result = new Vaadin7PortletTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_34 = NL + NL + "    public void init(VaadinRequest request) {" + NL + "        // set the window or tab title" + NL + "        getPage().setTitle(\"Hello window\");" + NL + "        " + NL + "        // Create the content root layout for the UI" + NL + "        VerticalLayout content = new VerticalLayout();" + NL + "        setContent(content);" + NL + "        " + NL + "        // Display the greeting" + NL + "        content.addComponent(new Label(\"Hello Vaadin user!\"));" + NL + "    }" + NL + "" + NL + "}";
