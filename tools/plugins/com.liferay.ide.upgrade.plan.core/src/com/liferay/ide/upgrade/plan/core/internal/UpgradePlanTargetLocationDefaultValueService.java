 ...
 * @author Terry Jia
 */
public class UpgradePlanTargetLocationDefaultValueService extends DefaultValueService {

	public UpgradePlanTargetLocationDefaultValueService() {
	...
	protected String compute() {
		...
		return targetProjectLocation.toString();
	}
