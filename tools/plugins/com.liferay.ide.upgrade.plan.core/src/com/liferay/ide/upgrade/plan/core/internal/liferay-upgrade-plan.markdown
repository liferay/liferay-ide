...
<ol id="root">
	...
	<ol>
		<li imagePath="" requirement="recommended">
	...
	<ol>
		...
		<ol>
			<li imagePath="" requirement="required" commandId="create_new_liferay_workspace">
			...
			<li imagePath="" requirement="required" commandId="import_existing_projects">
		...
		<li imagePath="" requirement="required" commandId="initialize_server_bundle">
	...
	<ol>
		<li imagePath="" commandId="remove_legacy_files" requirement="required">
		...
		<li imagePath="" commandId="rebuild_services" requirement="required">
