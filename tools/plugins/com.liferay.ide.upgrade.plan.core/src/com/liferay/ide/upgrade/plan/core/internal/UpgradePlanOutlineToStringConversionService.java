 ...
 * @author Simon Jiang
 */
public class UpgradePlanOutlineToStringConversionService extends ConversionService<IUpgradePlanOutline, String> {

	public UpgradePlanOutlineToStringConversionService() {
