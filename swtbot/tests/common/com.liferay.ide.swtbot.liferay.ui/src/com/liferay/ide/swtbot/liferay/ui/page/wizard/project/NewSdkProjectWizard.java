...
public class NewSdkProjectWizard extends NewProjectWizard {
	...
	public NewSdkProjectWizard(SWTWorkbenchBot bot, String title, int validationMsgIndex) {
		...
		_includeSimpleCode = new CheckBox(bot, INCLUDE_SAMPLE_CODE);
		_launchNewPortletWizard = new CheckBox(bot, LAUNCH_NEW_PORTLET_WIZARD_AFTER_PROJECT);
	}
	...
	public CheckBox getIncludeSimpleCode() {
		return _includeSimpleCode;
	}

	public CheckBox getLaunchNewPortletWizard() {
		return _launchNewPortletWizard;
	}
	...
	private CheckBox _includeSimpleCode;
	private CheckBox _launchNewPortletWizard;
	private ComboBox _pluginTypes;
