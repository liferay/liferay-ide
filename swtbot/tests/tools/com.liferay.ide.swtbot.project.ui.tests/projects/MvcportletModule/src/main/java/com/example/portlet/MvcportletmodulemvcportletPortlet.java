...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=MvcportletModule Portlet", "javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp", "javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class MvcportletmodulemvcportletPortlet extends MVCPortlet {
}