...
{
    ElementType TYPE = new ElementType( NewJoinXorNodeOp.class );

    @Type( base = NewJoinXorNode.class )
    @Label( standard = "new join XOR node" )
    ImpliedElementProperty PROP_NEW_JOIN_XOR_NODE = new ImpliedElementProperty( TYPE, "NewJoinXorNode" );

    NewJoinXorNode getNewJoinXorNode();
