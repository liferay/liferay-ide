 ...
 * @auther Greg Amerson
 */
public class PortalServerUIPlugin extends AbstractUIPlugin {
	...
	// The shared instance
	private static PortalServerUIPlugin plugin;
	 ...
	 */
	public static PortalServerUIPlugin getDefault() {
		return plugin;
	}
