...
public class PortalTomcatRuntimeDecorationsProvider implements IAdapterFactory {
	...
	public class PortalDecorationsProvider implements IDecorationsProvider {
		...
		public PortalDecorationsProvider(IRuntime adaptableObject) {
			// runtime = adaptableObject;
		}

		public ImageDescriptor getIcon() {
			return PortalTomcatUIPlugin.imageDescriptorFromPlugin(
				PortalTomcatUIPlugin.PLUGIN_ID, "icons/e16/server.png");
		}
