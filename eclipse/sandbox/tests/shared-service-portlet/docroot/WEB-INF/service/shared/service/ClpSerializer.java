...
public class ClpSerializer {
	public static final String SERVLET_CONTEXT_NAME = "shared-service-portlet";
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(FooClp.class.getName())) {
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("shared.model.impl.FooImpl",
							true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("shared.model.impl.FooImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
