...
import shared.model.FooModel;
import shared.model.FooSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link shared.model.FooModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FooImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. All methods that expect a foo model instance should use the {@link shared.model.Foo} interface instead.
 * </p>
 *
 * @author greg
 * @see FooImpl
 * @see shared.model.Foo
 * @see shared.model.FooModel
 * @generated
 */
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final String TABLE_SQL_CREATE = "create table FOO_Foo (fooId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.shared.model.Foo"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.shared.model.Foo"), true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.shared.model.Foo"));
