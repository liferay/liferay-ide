...
import shared.NoSuchFooException;

import shared.model.Foo;

import shared.model.impl.FooImpl;
import shared.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	public Foo updateImpl(shared.model.Foo foo, boolean merge)
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.shared.model.Foo")));
