/*******************************************************************************
 * Copyright (c) 2010 Liferay, Inc. All rights reserved.
 *
...
package com.liferay.ide.eclipse.portlet.ui.util;
...
public class PortalClassHelper extends LaunchHelper {
	...
	protected String[] defaultLibs = new String[] {
		"portal-kernel.jar"
	};
	...
	public ILaunchConfigurationWorkingCopy createLaunchConfiguration()
		...
		config.setAttribute(
			IDebugUIConstants.ATTR_CAPTURE_IN_FILE, PortletUIPlugin.getDefault().getStateLocation().append(
	...
	protected void addUserEntries(ClasspathModel model)
		...
		URL url = PortletCore.getDefault().getBundle().getEntry("portal-support/portal-support.jar");
