	...
	protected class AddEventActionDialog extends AddStringArrayDialog {
		...
		protected void handleSelectClassButton(Text text) {
			...
			try {
				...
				scope =
					BasicSearchEngine.createJavaSearchScope(new IJavaElement[] {
						JavaCore.create(CoreUtil.getProject(model.getStringProperty(INewJavaClassDataModelProperties.PROJECT_NAME)))
					});
