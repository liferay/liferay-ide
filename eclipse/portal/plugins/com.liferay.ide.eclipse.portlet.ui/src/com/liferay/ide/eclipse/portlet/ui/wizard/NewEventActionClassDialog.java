...
import com.liferay.ide.eclipse.portlet.core.operation.NewEventActionClassDataModelProvider;
import com.liferay.ide.eclipse.portlet.core.operation.NewEventActionClassOperation;
...
public class NewEventActionClassDialog extends Dialog {
	...
	protected void createSuperclassGroup(Composite parent) {
		...
		superCombo.setItems(new String[] {
