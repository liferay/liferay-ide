...
package com.liferay.ide.eclipse.layouttpl.ui.gef;
 ...
 * <P> <EM>IMPORTANT</EM>This class should only be used as a reference for
...
public abstract class GraphicalEditor extends EditorPart implements CommandStackListener, ISelectionListener {
	...
	/**
	 * Realizes the Editor by creating it's Control. <P>WARNING: This method may
	 * or may not be called by the workbench prior to {@link #dispose()}.
	 * 
	 * @param parent
	 *            the parent composite
	 */
	...
	/**
	 * Returns the adapter for the specified key. <P><EM>IMPORTANT</EM> certain
	 * requests, such as the property sheet, may be made before or after
	 * {@link #createPartControl(Composite)} is called. The order is unspecified
	 * by the Workbench.
	 * 
	 ...
	 * <code>super.init(site, input) </code>.
	 * 
	 ...
	 * {@link ContextMenuProvider ContextMenuProviders}. <P>This method may be
	 * called on Editor creation, or lazily the first time
