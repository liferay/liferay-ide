...
public class PortletNamePossibleValueService extends PossibleValuesService {
	...
	private IPortletApp portletApp;
	...
	public void init( IModelElement element, ModelProperty property, String[] params ) {
		...
		IResource eresource = element.resource().adapt( IFile.class );
		...
		try {
			...
			if ( resource != null ) {
				...
				portletApp = IPortletApp.TYPE.instantiate( portletXmlResource );
	...
	protected void fillPossibleValues( SortedSet<String> values ) {
		if ( portletApp != null ) {
			List<IPortlet> portlets = portletApp.getPortlets();
