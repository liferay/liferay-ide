...
public class NewPluginProjectGroup extends NewProjectGroup implements IPluginProjectDataModelProperties {
	...
	protected void createProjectLocationGroup(Composite parent) {
		...
		sdkLocationButton = SWTUtil.createRadioButton(projectLocationGroup, "Create new project in SDK", null, true, 3);
		...
		customLocationButton = SWTUtil.createRadioButton(projectLocationGroup, "Create new project in:", null, true, 3);
	...
	protected void createProjectNameGroup(Composite parent) {
		...
		nestedSynchHelper.synchText(projectNameField, PROJECT_NAME, new Control[] {
			projectLabel
		});
	}
