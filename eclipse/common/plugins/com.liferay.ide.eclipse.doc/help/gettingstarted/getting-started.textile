...
# In the Liferay project wizard page, the newly configured SDK and Liferay Runtime should be pre-selected.  Also the plugin type "portlet" is the default.  Simply time in a project name and cooresponding display name and click Finish. <br/><br/>!images/lide_getting_started_12a.png!<br/><br/>
