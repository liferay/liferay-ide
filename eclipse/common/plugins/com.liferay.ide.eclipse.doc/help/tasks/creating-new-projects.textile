...
# To create a new plug-in project with Liferay IDE, select the Liferay Plug-in Project option from the Eclipse File menu. (Go to File > New > Liferay Plug-in Project). <br/><br/>!file:images/lide_creating_new_plugins_1.png!<br/><br/>
...
# On this page, you will input the information required to create a portlet class.
...
# First, you need to select a name for your new hook project. Then you can specify which hook type(s) to create by checking the appropriate boxes. After making your selections, click Next. <br/><br/>!images/lide-new-hook2.png!<br/><br/>
# If you selected Create JSPs, you will need to create a custom JSP folder and specify specific JSP files to overwrite. Click next. <br/><br/>!images/lide-new-hook3.png!<br/><br/>
# If you selected Portal properties, you will need to either define actions to be executed on portal events or specify portal properties to override. Click next. <br/><br/>!images/lide-new-hook4.png!<br/><br/>
# If you selected services, you will need to specify which Liferay services to extend. Click next. <br/><br/>!images/lide-new-hook5.png!<br/><br/>
