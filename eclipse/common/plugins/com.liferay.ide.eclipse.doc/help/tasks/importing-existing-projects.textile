<div style="font-size:2em">Importing Existing Projects into Liferay IDE</div>

{toc}

h1. Requirements for this Task
...
h1(#non-eclipse-guide). Import Guide: Existing Liferay Project not in an Eclipse workspace 
...
h2(#option-1). Create Project from Existing Source wizard
...
h2(#option-2). Create Multiple Projects from Existing SDK
...
h1(#non-ide-guide). Import Guide: Existing Eclipse, non-Liferay IDE project
...
h2. Convert Liferay Project Wizard
...
h1(#ide-guide). Import Guide: Existing Liferay IDE project 
...
h1(#verify). Verify Project Import Success
