...
import com.liferay.ide.eclipse.velocity.editor.VelocityCompletionProcessor;
import com.liferay.ide.eclipse.velocity.editor.VelocityEditor;
import com.liferay.ide.eclipse.velocity.scanner.HTMLScanner;
import com.liferay.ide.eclipse.velocity.scanner.HTMLScriptScanner;
import com.liferay.ide.eclipse.velocity.scanner.HTMLTagScanner;
import com.liferay.ide.eclipse.velocity.scanner.NonRuleBasedDamagerRepairer;
...
import com.liferay.ide.eclipse.velocity.ui.editor.xml.WholePartitionDamagerRepairer;
import com.liferay.ide.eclipse.velocity.vaulttec.ui.IColorConstants;
...
public class VelocityConfiguration extends SourceViewerConfiguration implements IEditorConfiguration
{
    ...
    static
    {
        ...
        for (int i = 0; i < com.liferay.ide.eclipse.velocity.ui.editor.xml.IHTMLConstants.EMPTY_TAGS.length; i++)
        {
            fEMPTY_TAG_SET.add(com.liferay.ide.eclipse.velocity.ui.editor.xml.IHTMLConstants.EMPTY_TAGS[i]);
        }
    }
